      ...
      <div className="min-h-screen bg-[#0a0a0b] text-white font-['DM_Sans',sans-serif] relative overflow-hidden">
        ...
        {showTutorial && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            />
            <div className="relative w-full max-w-3xl bg-[#141416] rounded-2xl border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              {/* Header */}
              <div className="px-6 py-4 border-b border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-['Sora',sans-serif] text-lg font-semibold text-white">Getting Started Tutorial</h2>
                    <p className="text-sm text-white/40">Learn how to build high-converting landing pages</p>
                  </div>
                </div>
                <button
                  onClick={() => setShowTutorial(false)}
              ...
              <div className="aspect-video bg-black/50 flex items-center justify-center">
                {/* Replace with your video embed - YouTube, Vimeo, or Loom */}
                <div className="text-center">
                  ...
                  <p className="text-white/20 text-xs mt-1">Replace this with your YouTube/Vimeo/Loom embed</p>
                </div>
                {/*
              ...
              <div className="p-6 bg-white/[0.02]">
                <h3 className="font-['Sora',sans-serif] font-semibold text-white mb-4 flex items-center gap-2">
                  <svg className="w-5 h-5 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03]">
                    ...
                    <div>
                      <p className="text-white/80 text-sm font-medium">Create your first landing page</p>
                      <p className="text-white/40 text-xs mt-0.5">Start from scratch or use a template</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <div className="w-6 h-6 rounded-full bg-emerald-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <p className="text-white/80 text-sm font-medium">Use the visual editor</p>
                      <p className="text-white/40 text-xs mt-0.5">Customize every section easily</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <div className="w-6 h-6 rounded-full bg-emerald-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <p className="text-white/80 text-sm font-medium">Publish your page</p>
                      <p className="text-white/40 text-xs mt-0.5">Go live with one click</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03]">
                    <div className="w-6 h-6 rounded-full bg-emerald-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <p className="text-white/80 text-sm font-medium">Connect your domain</p>
                      <p className="text-white/40 text-xs mt-0.5">Use your own custom domain</p>
                    </div>
                  </div>
                </div>
              </div>
