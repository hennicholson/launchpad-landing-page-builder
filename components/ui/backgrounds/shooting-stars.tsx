...
interface ShootingStarsLayerProps {
  minSpeed?: number;
  maxSpeed?: number;
  minDelay?: number;
  maxDelay?: number;
...
function ShootingStarsLayer({
  ...
  useEffect(() => {
    ...
    const moveStar = () => {
      ...
      animationId = requestAnimationFrame(moveStar);
    };
...
export function ShootingStarsBackground({ className }: ShootingStarsBackgroundProps) {
  return (
    <div
