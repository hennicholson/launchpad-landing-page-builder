...
export const StoriesContent = ({
  ...
  <CarouselContent className={cn('snap-x snap-mandatory scrollbar-hide', className)} {...props} />
);

export type StoryProps = HTMLAttributes<HTMLDivElement>;

export const Story = ({ className, ...props }: StoryProps) => (
  <CarouselItem className={cn('shrink-0 snap-start pl-3 md:pl-4', className)}>
    <div
      className={cn(
        'group relative h-full w-full overflow-hidden rounded-2xl bg-muted/40',
