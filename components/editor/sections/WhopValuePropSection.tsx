...
import { ValuePropositionStory } from "@/components/shared/sections/whop-university";
...
export default React.memo(function WhopValuePropSection({ section }: Props) {
  const { page } = useEditorStoreOrPublished();

  return (
    <ValuePropositionStory
      section={section}
