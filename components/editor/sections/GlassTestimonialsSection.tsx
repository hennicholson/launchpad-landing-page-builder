...
import { GlassTestimonialsBase } from "@/components/shared/sections/glass";
...
export default React.memo(function GlassTestimonialsSection({ section }: Props) {
  const { page } = useEditorStoreOrPublished();

  return (
    <GlassTestimonialsBase
      section={section}
