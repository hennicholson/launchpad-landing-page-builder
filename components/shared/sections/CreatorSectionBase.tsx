        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="order-1 lg:order-1">
              ...
              {/* Social Links */}
              {(content.twitterUrl || content.instagramUrl || content.linkedinUrl || content.youtubeUrl || content.tiktokUrl) && (
                <div className="flex justify-center gap-2 sm:gap-3 mt-4 sm:mt-6 max-w-md mx-auto">
                  {content.twitterUrl && (
                    <a
                      href={content.twitterUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center transition-all hover:scale-105"
                      style={{ backgroundColor: `${textColor}10` }}
                    >
                      <svg className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: textColor }} fill="currentColor" viewBox="0 0 24 24">
