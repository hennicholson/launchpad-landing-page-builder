...
export default function HeroSalesFunnel({
  ...
  const renderBadgeIcon = () => {
    ...
    if (content.badgeIcon === "checkmark" || !content.badgeIcon) {
      return (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke={iconColor} strokeWidth={3}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
        </svg>
      );
    } else if (content.badgeIcon === "shield") {
      return (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke={iconColor} strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        </svg>
      );
    } else if (content.badgeIcon === "star") {
      return (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill={iconColor} stroke={iconColor} strokeWidth={1}>
          ...
          {content.topTitle && (
            ...
            >
              {renderText ? (
                ...
                <p className="text-sm md:text-base" style={{ color: textColor, fontFamily: bodyFont, opacity: 0.8 }}>
                  {content.topTitle}
                </p>
              )}
            </motion.div>
          ...
          {content.heading && (
            ...
            >
              {renderText ? (
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight" style={{ color: textColor, fontFamily: headingFont }}>
                  {content.heading}
                </h1>
              )}
            </motion.div>
          ...
          {content.subheading && (
            ...
            >
              {renderText ? (
                ...
                <p className="text-lg md:text-xl" style={{ color: textColor, fontFamily: bodyFont, opacity: 0.9 }}>
                  {content.subheading}
                </p>
              )}
            </motion.div>
            ...
            >
              {renderButton ? (
                renderButton({
                  ...
                  sectionId: section.id,
                  field: "ctaText",
                  className: "inline-block px-8 py-4 text-lg font-bold rounded-lg shadow-md hover:shadow-lg transition-shadow",
                  style: {
            ...
            >
              ...
              >
                ...
                {renderText ? (
                  ...
                  <span className="text-sm font-semibold uppercase tracking-wider" style={{ color: textColor, fontFamily: bodyFont }}>
                    {content.badge}
                  </span>
                )}
              </div>
